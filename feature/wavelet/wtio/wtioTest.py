    ...
    if subband == 'all':
        ...
        for n in range(1,level+1):
            ...
            for i in temp:
                # pop index
                print(i)
                print(wp[i].data.shape)
                #print(np.abs(wp[i].data))
                print("============================")
                del index[0]
...
def _wtioPreprocess(image, resize):
    ...
    if cols > resize:
        ...
        newCols = resize
        print("resize baru ", newCols, newRows)
...
if __name__ == '__main__':
    ...
    params["subband"] = "all"
    params["plot"] = False 
    extract("0cd24b0c-0a9d-483f-8734-5c08988e029f___FREC_C.Rust 3762.JPG", params, "/home/akhiyar/Software/feature/wavelet/wtio", "apple")
