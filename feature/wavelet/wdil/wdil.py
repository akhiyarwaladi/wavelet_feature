...
def extract(imgFpath,params,kernel,outdir,tag,distinct):
    ...
    if params['plot'] == True:
        ...
        features.append(_waveletPacket(GminR, plotOutdir+'blueChannel_', params['level'], kernel, params['subband'], params['plot'], distinct))
        features.append(_waveletPacket(GminB, plotOutdir+'greenChannel_', params['level'], kernel, params['subband'], params['plot'], distinct))
        features.append(_waveletPacket(RminG, plotOutdir+'redChannel_', params['level'], kernel, params['subband'], params['plot'], distinct))
    else:
        features.append(_waveletPacket(GminR, os.path.join(outdir,tag), params['level'], kernel, params['subband'], params['plot'], distinct))
        features.append(_waveletPacket(GminB, os.path.join(outdir,tag), params['level'], kernel, params['subband'], params['plot'], distinct))
        features.append(_waveletPacket(RminG, os.path.join(outdir,tag), params['level'], kernel, params['subband'], params['plot'], distinct))
